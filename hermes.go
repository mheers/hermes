...
type Body struct {
	...
	IntroMarkdown Markdown // Intro sentences (in Markdown), first displayed in the email
	...
	OutroMarkdown Markdown // Outro sentences (in Markdown), last displayed in the email
